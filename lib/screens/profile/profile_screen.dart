  ...
  Widget _buildAboutMeContent() {
    return ListView(
      ...
      children: [
        ...
        _buildInfoItem("Email address", "qoidulghurri14@gmail.com"),
        _buildInfoItem("Program Studi", "S1 Teknik Informatika"),
        _buildInfoItem("Fakultas", "TI"),
  ...
  Widget _buildEditProfileContent() {
    return ListView(
      ...
      children: [
        ...
        _buildEditField("Email", "qoidulghurri14@gmail.com"),
        _buildEditField("Program Studi", "S1 Teknik Informatika"),
        _buildEditField("Fakultas", "TI"),
        _buildEditField("Nomor Telepon", "+62 838-4996-5163"),
        const SizedBox(height: 20),
        SizedBox(
          width: double.infinity,
          height: 50,
